...
@section('content')
    ...
    <div class="row justify-content-center">
        <div class="term-changer row justify-content-between col-md-10 p-0">
            <a href="{{ url('/sellers/record/?period=' . App\Appointment::getPrevPeriod($period)) }}"><i
                    class="fas fa-angle-left"></i>&nbsp;Prev</a>
            <a href="{{ url('/sellers/record/?period=' . App\Appointment::getNextPeriod($period)) }}">Next&nbsp;<i
                        ...
                        <th>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                    <a href="{{ route('users.seller_record', compact('period')) }}"
                                        class="dropdown-item">全て表示</a>
                                    @foreach ($sort_query as $key => $val)
                                        <a href="{{ route('users.seller_record', ['sort' => $val, 'period' => $period]) }}"
